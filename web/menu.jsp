...
<FORM id=form1 name=form1 action=YHMenu.aspx method=post>
    <TABLE cellSpacing=0 cellPadding=0 width=210 align=center border=0>
        ...
        <TR>
            ...
            <TD align="center" width=180 background="${pageContext.request.contextPath}/images/new_006.jpg" height=35>
                <B>人力资源 －功能菜单</B></TD>
        ...
        <TR>
            ...
            <TD vAlign=top width=180 bgColor=#ffffff>
                <TABLE cellSpacing=0 cellPadding=3 width=165 align=center border=0>
                        ...
                        <TD>
                            <TABLE id=table_2 style="DISPLAY: none" cellSpacing=0
                                ...
                                <TR>
                                    <TD class=menuSmall>
                                        <A class=style2
                                           href="${pageContext.request.contextPath}/linkman/LinkManServlet?method=addLinkManUI"
                                           target=main>－ 新增联系人</A>
                                    </TD>
                                </TR>
                                <TR>
                                    <TD class=menuSmall>
                                        <A class=style2
                                           href="${pageContext.request.contextPath}/linkman/LinkManServlet?method=listLinkMan"
                                           target=main>－联系人列表</A>
                                    </TD>
                                </TR>
                    ...
                    <TR>
                        <TD>
                            <TABLE id=table_5 style="DISPLAY: none" cellSpacing=0 cellPadding=2 width=155 align=center
                                ...
                                <TR>
                                    <TD class=menuSmall>
                                        <A class=style2 href="${pageContext.request.contextPath}/welcome.htm"
                    ...
                    <TR>
                        <TD>
                            <TABLE id=table_3 style="DISPLAY: none" cellSpacing=0 cellPadding=2 width=155 align=center
                                   border=0>
                                <TBODY>
                                <TR>
                                    <TD class=menuSmall>
    ...
    <TABLE cellSpacing=0 cellPadding=0 width=210 align=center border=0>
        ...
        <TR>
            ...
            <TD align="center" width=180 background="${pageContext.request.contextPath}/images/new_011.jpg"
                height=15></TD>
